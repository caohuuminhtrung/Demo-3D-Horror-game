public class Dialogues
{
  public string[][] dialogues = new string[][] {
    ...
    new string[] {},
    new string[] {},
    new string[] { "Darling?", "", "Are you awake?" , "", "I brought you some dinner.", "", "...", "I'll leave them at the door then.", "Remember to take the pills, ok.", "I gotta go home now. See you tommorow." },
